package com.pk.server.master.redis.config;

import com.alibaba.fastjson.parser.ParserConfig;
import com.fasterxml.jackson.annotation.JsonAutoDetect;
import com.fasterxml.jackson.annotation.PropertyAccessor;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.pk.server.master.redis.cache.CustomizedRedisCacheManager;
import com.pk.server.master.redis.serializer.FastJsonRedisSerializer;
import com.pk.server.master.redis.serializer.StringRedisSerializer;
...
public class RedisConfig {
    ...
    // redis缓存的有效时间单位是秒
    @Value("${redis.default.expiration:60}")
    ...
    public RedisTemplate<String, Object> redisTemplate(RedisConnectionFactory redisConnectionFactory) {
        ...
        // 建议使用这种方式，小范围指定白名单
        ParserConfig.getGlobalInstance().addAccept("com.ls.api");
