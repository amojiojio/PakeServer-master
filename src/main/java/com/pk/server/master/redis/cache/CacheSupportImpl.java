package com.pk.server.master.redis.cache;

import com.pk.server.master.redis.cache.expression.CacheOperationExpressionEvaluator;
import com.pk.server.master.redis.utils.RedisTemplateUtils;
import com.pk.server.master.redis.utils.ReflectionUtils;
import com.pk.server.master.redis.utils.SpringContextUtils;
...
public class CacheSupportImpl implements CacheSupport {
    ...
    public void registerInvocation(Object targetBean, Method targetMethod, Class[] invocationParamTypes,
        ...
        for (Cache cache : caches) {
            if (cache instanceof com.pk.server.master.redis.cache.CustomizedRedisCache) {
                com.pk.server.master.redis.cache.CustomizedRedisCache redisCache = ((com.pk.server.master.redis.cache.CustomizedRedisCache) cache);
                // 将方法信息放到redis缓存
