package com.pk.server.wechat.core.util;
...
public class HttpUtil extends org.springframework.web.util.WebUtils {
    ...
    public static String getRequestFullUriNoContextPath(HttpServletRequest request) {
        ...
        String callBack = request.getScheme() + "://" + request.getServerName() + port + request.getServletPath();
        if (request.getQueryString() != null) {
            callBack += "?" + request.getQueryString();
        }
        return callBack;
//		return request.getScheme() + "://" + request.getServerName() + port + "/SuTa"+request.getServletPath();
