...
public class AccountMenu extends BaseEntity {
    ...
    public String toString() {
        return "AccountMenu [mtype=" + mtype + ", eventType=" + eventType + ", name=" + name + ", inputcode="
                + inputcode + ", url=" + url + ", sort=" + sort + ", parentid=" + parentid + ", msgId=" + msgId
                + ", parentName=" + parentName + ", gid=" + gid + "]";
    }
