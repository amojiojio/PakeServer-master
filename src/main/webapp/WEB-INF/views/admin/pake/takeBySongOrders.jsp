                ...
                <div class="padding" style="margin-bottom: -3.9rem;">
                    <div class="box">
                        <div class="box-body p-v-md">
                            <form class="form-inline" role="form" action="/admin/takeBySongOrders" method="post">
                ...
                <div class="padding">
                    <div class="box">
                        <div class="box-header" style="height: 80px">
                            <h3 style="margin-left: 10px;margin-top: 10px">寄件订单
                            </h3>
                        </div>
...
<script>
    function taking(id){
        layer.open({
            ...
            shadeClose: true,
            area: ['80%', '70%'],
            content: '${pageContext.request.contextPath}/admin/lookBySong?id='+id
        });
    };
</script>
</body>
